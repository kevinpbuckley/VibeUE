...
# Compile via the ENGINE NiagaraToolsets (system/compile CRUD is engine-owned), then save:
# call_tool("NiagaraToolsets.NiagaraToolset_System", "<compile tool>", {... SYSTEM ...})
