...
3. **Layering** — longest-path layering assigns each node to a horizontal layer. Exec edges are weighted 99× higher than data edges so the exec spine drives the column ordering.
