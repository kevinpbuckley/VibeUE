...
// =============================
// FBlueprintVariableCommandContext (partial)
// =============================
TUniquePtr<FBlueprintVariableCommandContext> FBlueprintVariableCommandContext::Instance;

FBlueprintVariableCommandContext::FBlueprintVariableCommandContext() {}
FBlueprintVariableCommandContext::~FBlueprintVariableCommandContext() {}

void FBlueprintVariableCommandContext::Initialize()
{
    if (!bIsInitialized)
    {
...
void FBlueprintVariableCommandContext::Shutdown()
{
    CatalogService.Shutdown();
    bIsInitialized = false;
}

FBlueprintVariableCommandContext& FBlueprintVariableCommandContext::Get()
{
    if (!Instance.IsValid())
    {
        Instance = MakeUnique<FBlueprintVariableCommandContext>();
        Instance->Initialize();
    }
    return *Instance.Get();
}

TSharedPtr<FJsonObject> FBlueprintVariableCommandContext::ExecuteCommand(const FString& Action, const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FBlueprintVariableCommandContext::HandleSearchTypes(const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FBlueprintVariableCommandContext::HandleGetInfo(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
...
TSharedPtr<FJsonObject> FBlueprintVariableCommandContext::HandleModify(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    {
...
TSharedPtr<FJsonObject> FBlueprintVariableCommandContext::HandleGetProperty(const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FBlueprintVariableCommandContext::HandleSetProperty(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName; if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName)) return FResponseSerializer::CreateErrorResponse(TEXT("PARAM_MISSING"), TEXT("Missing 'blueprint_name'"));
    FString Path; if (!Params->TryGetStringField(TEXT("path"), Path) && !Params->TryGetStringField(TEXT("property_path"), Path)) return FResponseSerializer::CreateErrorResponse(TEXT("PARAM_MISSING"), TEXT("Missing 'path' or 'property_path'"));
...
TSharedPtr<FJsonObject> FBlueprintVariableCommandContext::HandleGetPropertyMetadata(const TSharedPtr<FJsonObject>& /*Params*/) { return FResponseSerializer::CreateErrorResponse(TEXT("UNIMPL"), TEXT("get_property_metadata not implemented")); }
TSharedPtr<FJsonObject> FBlueprintVariableCommandContext::HandleSetPropertyMetadata(const TSharedPtr<FJsonObject>& /*Params*/) { return FResponseSerializer::CreateErrorResponse(TEXT("UNIMPL"), TEXT("set_property_metadata not implemented")); }
TSharedPtr<FJsonObject> FBlueprintVariableCommandContext::HandleDiagnostics(const TSharedPtr<FJsonObject>& /*Params*/) {
    TSharedPtr<FJsonObject> Data = MakeShared<FJsonObject>();
...
bool FBlueprintVariableCommandContext::ParseRequestParams(const TSharedPtr<FJsonObject>& Params, FString& OutBlueprintName, FString& OutError)
{
