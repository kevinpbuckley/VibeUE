...
public:
    ...
    static class UWidgetBlueprint* FindWidgetBlueprint(const FString& WidgetBlueprintName);
    static class FWidgetBlueprintEditor* GetWidgetBlueprintEditor(class UWidgetBlueprint* WidgetBlueprint);
    ...
    // ENHANCED (Oct 6, 2025): Context-aware variable nodes with external member support
    ...
    static bool SafeCompileBlueprint(UBlueprint* Blueprint, FString& OutError);
}; 
